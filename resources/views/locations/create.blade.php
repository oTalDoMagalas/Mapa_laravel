...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>
                <div class="fas fa-plus me-2"></div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-3"><small class="text-muted"><i class="fas fa-info-circle me-1"></i></small></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card-header">
            <h5 class="card-title mb-0"><i class="fas fa-edit me-2"></i></h5>
        </div>
        <div class="card-body">
